#ifndef OPENANN_LAYERS_RBF_H_
#define OPENANN_LAYERS_RBF_H_
 ...
 * layer.
 *
 * Forward propagation is usually done by \f$ a = W \cdot x + b, y =
...
protected:
  ...
  Eigen::MatrixXd* x;
  Eigen::MatrixXd dist;
  Eigen::MatrixXd a; // z in equations
  Eigen::MatrixXd y; // a in equations
  Eigen::MatrixXd yd;
